...
REM IF DEFINED KUDU_SELECT_PYTHON_VERSION_CMD (
REM  call %KUDU_SELECT_PYTHON_VERSION_CMD% "%DEPLOYMENT_SOURCE%" "%DEPLOYMENT_TARGET%" "%DEPLOYMENT_TEMP%"
REM  IF !ERRORLEVEL! NEQ 0 goto error

REM  SET /P PYTHON_RUNTIME=<"%DEPLOYMENT_TEMP%\__PYTHON_RUNTIME.tmp"
REM  IF !ERRORLEVEL! NEQ 0 goto error

REM  SET /P PYTHON_VER=<"%DEPLOYMENT_TEMP%\__PYTHON_VER.tmp"
REM  IF !ERRORLEVEL! NEQ 0 goto error

REM  SET /P PYTHON_EXE=<"%DEPLOYMENT_TEMP%\__PYTHON_EXE.tmp"
REM  IF !ERRORLEVEL! NEQ 0 goto error

REM  SET /P PYTHON_ENV_MODULE=<"%DEPLOYMENT_TEMP%\__PYTHON_ENV_MODULE.tmp"
REM  IF !ERRORLEVEL! NEQ 0 goto error
REM ) ELSE (
